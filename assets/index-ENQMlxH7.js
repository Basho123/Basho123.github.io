...
`,-1),l())),t.components.length&&(Gu(t.components,"component",n),(t.directives.length||t.temps>0)&&l()),t.directives.length&&(Gu(t.directives,"directive",n),t.temps>0&&l()),t.filters&&t.filters.length&&(l(),Gu(t.filters,"filter",n),l()),t.temps>0){s("let ");for(let _=0;_<t.temps;_++)s(`${_>0?", ":""}_temp${_}`)}return(t.components.length||t.directives.length||t.temps)&&(s(`
...
`,-1),t.hoists.length)){const h=[ld,cd,ya,ud,q0].filter(f=>u.includes(f)).map(uv).join(", ");s(`const { ${h} } = _Vue
`,-1)}Zb(t.hoists,e),r(),s("return ")}function Gu(t,e,{helper:n,push:i,newline:s,isTS:r}){const o=n(e==="filter"?pd:e==="component"?hd:dd);for(let a=0;a<t.length;a++){let l=t[a];const c=l.endsWith("__self");c&&(l=l.slice(0,-6)),i(`const ${Qo(l,e)} = ${o}(${JSON.stringify(l)}${c?", true":""})${r?"!":""}`),a<t.length-1&&s()}}function Zb(t,e){if(!t.length)return;e.pure=!0;const{push:n,newline:i,helper:s,scopeId:r,mode:o}=e;i();for(let a=0;a<t.length;a++){const l=t[a];l&&(n(`const _hoisted_${a+1} = `),Zt(l,e),i())}e.pure=!1}function Td(t,e){const n=t.length>3||!1;e.push("["),n&&e.indent(),Ma(t,e,n),n&&e.deindent(),e.push("]")}function Ma(t,e,n=!1,i=!0){const{push:s,newline:r}=e;for(let o=0;o<t.length;o++){const a=t[o];ze(a)?s(a,-3):Te(a)?Td(a,e):Zt(a,e),o<t.length-1&&(n?(i&&s(","),r()):i&&s(", "))}}function Zt(t,e){if(ze(t)){e.push(t,-3);return}if(jn(t)){e.push(e.helper(t));return}switch(t.type){case 1:case 9:case 11:Zt(t.codegenNode,e);break;case 2:Jb(t,e);break;case 4:hv(t,e);break;case 5:Qb(t,e);break;case 12:Zt(t.codegenNode,e);break;case 8:fv(t,e);break;case 3:tT(t,e);break;case 13:nT(t,e);break;case 14:sT(t,e);break;case 15:rT(t,e);break;case 17:oT(t,e);break;case 18:aT(t,e);break;case 19:lT(t,e);break;case 20:cT(t,e);break;case 21:Ma(t.body,e,!0,!1);break}}function Jb(t,e){e.push(JSON.stringify(t.content),-3,t)}function hv(t,e){const{content:n,isStatic:i}=t;e.push(i?JSON.stringify(n):n,-3,t)}function Qb(t,e){const{push:n,helper:i,pure:s}=e;s&&n(vu),n(`${i(mu)}(`),Zt(t.content,e),n(")")}function fv(t,e){for(let n=0;n<t.children.length;n++){const i=t.children[n];ze(i)?e.push(i,-3):Zt(i,e)}}function eT(t,e){const{push:n}=e;if(t.type===8)n("["),fv(t,e),n("]");else if(t.isStatic){const i=bd(t.content)?t.content:JSON.stringify(t.content);n(i,-2,t)}else n(`[${t.content}]`,-3,t)}function tT(t,e){const{push:n,helper:i,pure:s}=e;s&&n(vu),n(`${i(ya)}(${JSON.stringify(t.content)})`,-3,t)}function nT(t,e){const{push:n,helper:i,pure:s}=e,{tag:r,props:o,children:a,patchFlag:l,dynamicProps:c,directives:u,isBlock:h,disableTracking:f,isComponent:d}=t;u&&n(i(md)+"("),h&&n(`(${i(Ks)}(${f?"true":""}), `),s&&n(vu);const g=h?Jr(e.inSSR,d):Zr(e.inSSR,d);n(i(g)+"(",-2,t),Ma(iT([r,o,a,l,c]),e),n(")"),h&&n(")"),u&&(n(", "),Zt(u,e),n(")"))}function iT(t){let e=t.length;for(;e--&&t[e]==null;);return t.slice(0,e+1).map(n=>n||"null")}function sT(t,e){const{push:n,helper:i,pure:s}=e,r=ze(t.callee)?t.callee:i(t.callee);s&&n(vu),n(r+"(",-2,t),Ma(t.arguments,e),n(")")}function rT(t,e){const{push:n,indent:i,deindent:s,newline:r}=e,{properties:o}=t;if(!o.length){n("{}",-2,t);return}const a=o.length>1||!1;n(a?"{":"{ "),a&&i();for(let l=0;l<o.length;l++){const{key:c,value:u}=o[l];eT(c,e),n(": "),Zt(u,e),l<o.length-1&&(n(","),r())}a&&s(),n(a?"}":" }")}function oT(t,e){Td(t.elements,e)}function aT(t,e){const{push:n,indent:i,deindent:s}=e,{params:r,returns:o,body:a,newline:l,isSlot:c}=t;c&&n(`_${Yr[xd]}(`),n("(",-2,t),Te(r)?Ma(r,e):r&&Zt(r,e),n(") => "),(l||a)&&(n("{"),i()),o?(l&&n("return "),Te(o)?Td(o,e):Zt(o,e)):a&&Zt(a,e),(l||a)&&(s(),n("}")),c&&(t.isNonScopedSlot&&n(", undefined, true"),n(")"))}function lT(t,e){const{test:n,consequent:i,alternate:s,newline:r}=t,{push:o,indent:a,deindent:l,newline:c}=e;if(n.type===4){const h=!bd(n.content);h&&o("("),hv(n,e),h&&o(")")}else o("("),Zt(n,e),o(")");r&&a(),e.indentLevel++,r||o(" "),o("? "),Zt(i,e),e.indentLevel--,r&&c(),r||o(" "),o(": ");const u=s.type===19;u||e.indentLevel++,Zt(s,e),u||e.indentLevel--,r&&l(!0)}function cT(t,e){const{push:n,helper:i,indent:s,deindent:r,newline:o}=e;n(`_cache[${t.index}] || (`),t.isVNode&&(s(),n(`${i(kl)}(-1),`),o()),n(`_cache[${t.index}] = `),Zt(t.value,e),t.isVNode&&(n(","),o(),n(`${i(kl)}(1),`),o(),n(`_cache[${t.index}]`),r()),n(")")}new RegExp("\\b"+"arguments,await,break,case,catch,class,const,continue,debugger,default,delete,do,else,export,extends,finally,for,function,if,import,let,new,return,super,switch,throw,try,var,void,while,with,yield".split(",").join("\\b|\\b")+"\\b");const uT=cv(/^(if|else|else-if)$/,(t,e,n)=>hT(t,e,n,(i,s,r)=>{const o=n.parent.children;let a=o.indexOf(i),l=0;for(;a-->=0;){const c=o[a];c&&c.type===9&&(l+=c.branches.length)}return()=>{if(r)i.codegenNode=Vp(s,l,n);else{const c=fT(i.codegenNode);c.alternate=Vp(s,l+i.branches.length-1,n)}}}));function hT(t,e,n,i){if(e.name!=="else"&&(!e.exp||!e.exp.content.trim())){const s=e.exp?e.exp.loc:t.loc;n.onError(gt(28,e.loc)),e.exp=je("true",!1,s)}if(e.name==="if"){const s=Hp(t,e),r={type:9,loc:t.loc,branches:[s]};if(n.replaceNode(r),i)return i(r,s,!0)}else{const s=n.parent.children;let r=s.indexOf(t);for(;r-->=-1;){const o=s[r];if(o&&o.type===3){n.removeNode(o);continue}if(o&&o.type===2&&!o.content.trim().length){n.removeNode(o);continue}if(o&&o.type===9){e.name==="else-if"&&o.branches[o.branches.length-1].condition===void 0&&n.onError(gt(30,t.loc)),n.removeNode();const a=Hp(t,e);o.branches.push(a);const l=i&&i(o,a,!1);_u(a,n),l&&l(),n.currentNode=null}else n.onError(gt(30,t.loc));break}}}function Hp(t,e){const n=t.tagType===3;return{type:10,loc:t.loc,condition:e.name==="else"?void 0:e.exp,children:n&&!Vn(t,"for")?t.children:[t],userKey:gu(t,"key"),isTemplateIf:n}}function Vp(t,e,n){return t.condition?Zh(t.condition,zp(t,e,n),Pt(n.helper(ya),['""',"true"])):zp(t,e,n)}function zp(t,e,n){const{helper:i}=n,s=St("key",je(`${e}`,!1,Tn,2)),{children:r}=t,o=r[0];if(r.length!==1||o.type!==1)if(r.length===1&&o.type===11){const l=o.codegenNode;return Gl(l,s,n),l}else return Zo(n,i(Yo),Dn([s]),r,64+"",void 0,void 0,!0,!1,!1,t.loc);else{const l=o.codegenNode,c=Pb(l);return c.type===13&&Md(c,n),Gl(c,s,n),l}}function fT(t){for(;;)if(t.type===19)if(t.alternate.type===19)t=t.alternate;else return t;else t.type===20&&(t=t.value)}const dT=cv("for",(t,e,n)=>{const{helper:i,removeHelper:s}=n;return pT(t,e,n,r=>{const o=Pt(i(gd),[r.source]),a=Vl(t),l=Vn(t,"memo"),c=gu(t,"key"),u=c&&(c.type===6?je(c.value.content,!0):c.exp),h=c?St("key",u):null,f=r.source.type===4&&r.source.constType>0,d=f?64:c?128:256;return r.codegenNode=Zo(n,i(Yo),void 0,o,d+"",void 0,void 0,!0,!f,!1,t.loc),()=>{let g;const{children:v}=r,m=v.length!==1||v[0].type!==1,p=zl(t)?t:a&&t.children.length===1&&zl(t.children[0])?t.children[0]:null;if(p?(g=p.codegenNode,a&&h&&Gl(g,h,n)):m?g=Zo(n,i(Yo),h?Dn([h]):void 0,t.children,"64",void 0,void 0,!0,void 0,!1):(g=v[0].codegenNode,a&&h&&Gl(g,h,n),g.isBlock!==!f&&(g.isBlock?(s(Ks),s(Jr(n.inSSR,g.isComponent))):s(Zr(n.inSSR,g.isComponent))),g.isBlock=!f,g.isBlock?(i(Ks),i(Jr(n.inSSR,g.isComponent))):i(Zr(n.inSSR,g.isComponent))),l){const x=Kr(ef(r.parseResult,[je("_cached")]));x.body=xb([qn(["const _memo = (",l.exp,")"]),qn(["if (_cached",...u?[" && _cached.key === ",u]:[],` && ${n.helperString(Y0)}(_cached, _memo)) return _cached`]),qn(["const _item = ",g]),je("_item.memo = _memo"),je("return _item")]),o.arguments.push(x,je("_cache"),je(String(n.cached++)))}else o.arguments.push(Kr(ef(r.parseResult),g,!0))}})});function pT(t,e,n,i){if(!e.exp){n.onError(gt(31,e.loc));return}const s=e.forParseResult;if(!s){n.onError(gt(32,e.loc));return}dv(s);const{addIdentifiers:r,removeIdentifiers:o,scopes:a}=n,{source:l,value:c,key:u,index:h}=s,f={type:11,loc:e.loc,source:l,valueAlias:c,keyAlias:u,objectIndexAlias:h,parseResult:s,children:Vl(t)?t.children:[t]};n.replaceNode(f),a.vFor++;const d=i&&i(f);return()=>{a.vFor--,d&&d()}}function dv(t,e){t.finalized||(t.finalized=!0)}function ef({value:t,key:e,index:n},i=[]){return mT([t,e,n,...i])}function mT(t){let e=t.length;for(;e--&&!t[e];);return t.slice(0,e+1).map((n,i)=>n||je("_".repeat(i+1),!1))}const Gp=je("undefined",!1),gT=(t,e)=>{if(t.type===1&&(t.tagType===1||t.tagType===3)){const n=Vn(t,"slot");if(n)return n.exp,e.scopes.vSlot++,()=>{e.scopes.vSlot--}}},_T=(t,e,n,i)=>Kr(t,n,!1,!0,n.length?n[0].loc:i);function vT(t,e,n=_T){e.helper(xd);const{children:i,loc:s}=t,r=[],o=[];let a=e.scopes.vSlot>0||e.scopes.vFor>0;const l=Vn(t,"slot",!0);if(l){const{arg:m,exp:p}=l;m&&!hn(m)&&(a=!0),r.push(St(m||je("default",!0),n(p,void 0,i,s)))}let c=!1,u=!1;const h=[],f=new Set;let d=0;for(let m=0;m<i.length;m++){const p=i[m];let x;if(!Vl(p)||!(x=Vn(p,"slot",!0))){p.type!==3&&h.push(p);continue}if(l){e.onError(gt(37,x.loc));break}c=!0;const{children:_,loc:E}=p,{arg:w=je("default",!0),exp:T,loc:C}=x;let L;hn(w)?L=w?w.content:"default":a=!0;const S=Vn(p,"for"),M=n(T,S,_,E);let N,O;if(N=Vn(p,"if"))a=!0,o.push(Zh(N.exp,Ga(w,M,d++),Gp));else if(O=Vn(p,/^else(-if)?$/,!0)){let $=m,I;for(;$--&&(I=i[$],I.type===3););if(I&&Vl(I)&&Vn(I,"if")){i.splice(m,1),m--;let V=o[o.length-1];for(;V.alternate.type===19;)V=V.alternate;V.alternate=O.exp?Zh(O.exp,Ga(w,M,d++),Gp):Ga(w,M,d++)}else e.onError(gt(30,O.loc))}else if(S){a=!0;const $=S.forParseResult;$?(dv($),o.push(Pt(e.helper(gd),[$.source,Kr(ef($),Ga(w,M),!0)]))):e.onError(gt(32,S.loc))}else{if(L){if(f.has(L)){e.onError(gt(38,C));continue}f.add(L),L==="default"&&(u=!0)}r.push(St(w,M))}}if(!l){const m=(p,x)=>{const _=n(p,void 0,x,s);return e.compatConfig&&(_.isNonScopedSlot=!0),St("default",_)};c?h.length&&h.some(p=>pv(p))&&(u?e.onError(gt(39,h[0].loc)):r.push(m(void 0,h))):r.push(m(void 0,i))}const g=a?2:El(t.children)?3:1;let v=Dn(r.concat(St("_",je(g+"",!1))),s);return o.length&&(v=Pt(e.helper($0),[v,Sa(o)])),{slots:v,hasDynamicSlots:a}}function Ga(t,e,n){const i=[St("name",t),St("fn",e)];return n!=null&&i.push(St("key",je(String(n),!0))),Dn(i)}function El(t){for(let e=0;e<t.length;e++){const n=t[e];switch(n.type){case 1:if(n.tagType===2||El(n.children))return!0;break;case 9:if(El(n.branches))return!0;break;case 10:case 11:if(El(n.children))return!0;break}}return!1}function pv(t){return t.type!==2&&t.type!==12?!0:t.type===2?!!t.content.trim():pv(t.content)}const mv=new WeakMap,yT=(t,e)=>function(){if(t=e.currentNode,!(t.type===1&&(t.tagType===0||t.tagType===1)))return;const{tag:i,props:s}=t,r=t.tagType===1;let o=r?xT(t,e):`"${i}"`;const a=at(o)&&o.callee===fd;let l,c,u,h=0,f,d,g,v=a||o===Uo||o===ad||!r&&(i==="svg"||i==="foreignObject");if(s.length>0){const m=gv(t,e,void 0,r,a);l=m.props,h=m.patchFlag,d=m.dynamicPropNames;const p=m.directives;g=p&&p.length?Sa(p.map(x=>MT(x,e))):void 0,m.shouldUseBlock&&(v=!0)}if(t.children.length>0)if(o===Fl&&(v=!0,h|=1024),r&&o!==Uo&&o!==Fl){const{slots:p,hasDynamicSlots:x}=vT(t,e);c=p,x&&(h|=1024)}else if(t.children.length===1&&o!==Uo){const p=t.children[0],x=p.type,_=x===5||x===8;_&&Nn(p,e)===0&&(h|=1),_||x===2?c=p:c=t.children}else c=t.children;h!==0&&(u=String(h),d&&d.length&&(f=ET(d))),t.codegenNode=Zo(e,o,l,c,u,f,g,!!v,!1,r,t.loc)};function xT(t,e,n=!1){let{tag:i}=t;const s=tf(i),r=gu(t,"is");if(r)if(s||Hs("COMPILER_IS_ON_ELEMENT",e)){const a=r.type===6?r.value&&je(r.value.content,!0):r.exp;if(a)return Pt(e.helper(fd),[a])}else r.type===6&&r.value.content.startsWith("vue:")&&(i=r.value.content.slice(4));const o=Z0(i)||e.isBuiltInComponent(i);return o?(n||e.helper(o),o):(e.helper(hd),e.components.add(i),Qo(i,"component"))}function gv(t,e,n=t.props,i,s,r=!1){const{tag:o,loc:a,children:l}=t;let c=[];const u=[],h=[],f=l.length>0;let d=!1,g=0,v=!1,m=!1,p=!1,x=!1,_=!1,E=!1;const w=[],T=S=>{c.length&&(u.push(Dn(Wp(c),a)),c=[]),S&&u.push(S)},C=({key:S,value:M})=>{if(hn(S)){const N=S.content,O=Qs(N);if(O&&(!i||s)&&N.toLowerCase()!=="onclick"&&N!=="onUpdate:modelValue"&&!Ns(N)&&(x=!0),O&&Ns(N)&&(E=!0),O&&M.type===14&&(M=M.arguments[0]),M.type===20||(M.type===4||M.type===8)&&Nn(M,e)>0)return;N==="ref"?v=!0:N==="class"?m=!0:N==="style"?p=!0:N!=="key"&&!w.includes(N)&&w.push(N),i&&(N==="class"||N==="style")&&!w.includes(N)&&w.push(N)}else _=!0};for(let S=0;S<n.length;S++){const M=n[S];if(M.type===6){const{loc:N,name:O,nameLoc:$,value:I}=M;let V=!0;if(O==="ref"&&(v=!0,e.scopes.vFor>0&&c.push(St(je("ref_for",!0),je("true")))),O==="is"&&(tf(o)||I&&I.content.startsWith("vue:")||Hs("COMPILER_IS_ON_ELEMENT",e)))continue;c.push(St(je(O,!0,$),je(I?I.content:"",V,I?I.loc:N)))}else{const{name:N,arg:O,exp:$,loc:I,modifiers:V}=M,H=N==="bind",Y=N==="on";if(N==="slot"){i||e.onError(gt(40,I));continue}if(N==="once"||N==="memo"||N==="is"||H&&Cs(O,"is")&&(tf(o)||Hs("COMPILER_IS_ON_ELEMENT",e))||Y&&r)continue;if((H&&Cs(O,"key")||Y&&f&&Cs(O,"vue:before-update"))&&(d=!0),H&&Cs(O,"ref")&&e.scopes.vFor>0&&c.push(St(je("ref_for",!0),je("true"))),!O&&(H||Y)){if(_=!0,$)if(H){if(T(),Hs("COMPILER_V_BIND_OBJECT_ORDER",e)){u.unshift($);continue}u.push($)}else T({type:14,loc:I,callee:e.helper(yd),arguments:i?[$]:[$,"true"]});else e.onError(gt(H?34:35,I));continue}H&&V.includes("prop")&&(g|=32);const z=e.directiveTransforms[N];if(z){const{props:ne,needRuntime:ce}=z(M,t,e);!r&&ne.forEach(C),Y&&O&&!hn(O)?T(Dn(ne,a)):c.push(...ne),ce&&(h.push(M),jn(ce)&&mv.set(M,ce))}else Bx(N)||(h.push(M),f&&(d=!0))}}let L;if(u.length?(T(),u.length>1?L=Pt(e.helper(Bl),u,a):L=u[0]):c.length&&(L=Dn(Wp(c),a)),_?g|=16:(m&&!i&&(g|=2),p&&!i&&(g|=4),w.length&&(g|=8),x&&(g|=32)),!d&&(g===0||g===32)&&(v||E||h.length>0)&&(g|=512),!e.inSSR&&L)switch(L.type){case 15:let S=-1,M=-1,N=!1;for(let I=0;I<L.properties.length;I++){const V=L.properties[I].key;hn(V)?V.content==="class"?S=I:V.content==="style"&&(M=I):V.isHandlerKey||(N=!0)}const O=L.properties[S],$=L.properties[M];N?L=Pt(e.helper(Ko),[L]):(O&&!hn(O.value)&&(O.value=Pt(e.helper(_d),[O.value])),$&&(p||$.value.type===4&&$.value.content.trim()[0]==="["||$.value.type===17)&&($.value=Pt(e.helper(vd),[$.value])));break;case 14:break;default:L=Pt(e.helper(Ko),[Pt(e.helper(xa),[L])]);break}return{props:L,directives:h,patchFlag:g,dynamicPropNames:w,shouldUseBlock:d}}function Wp(t){const e=new Map,n=[];for(let i=0;i<t.length;i++){const s=t[i];if(s.key.type===8||!s.key.isStatic){n.push(s);continue}const r=s.key.content,o=e.get(r);o?(r==="style"||r==="class"||Qs(r))&&ST(o,s):(e.set(r,s),n.push(s))}return n}function ST(t,e){t.value.type===17?t.value.elements.push(e.value):t.value=Sa([t.value,e.value],t.loc)}function MT(t,e){const n=[],i=mv.get(t);i?n.push(e.helperString(i)):(e.helper(dd),e.directives.add(t.name),n.push(Qo(t.name,"directive")));const{loc:s}=t;if(t.exp&&n.push(t.exp),t.arg&&(t.exp||n.push("void 0"),n.push(t.arg)),Object.keys(t.modifiers).length){t.arg||(t.exp||n.push("void 0"),n.push("void 0"));const r=je("true",!1,s);n.push(Dn(t.modifiers.map(o=>St(o,r)),s))}return Sa(n,t.loc)}function ET(t){let e="[";for(let n=0,i=t.length;n<i;n++)e+=JSON.stringify(t[n]),n<i-1&&(e+=", ");return e+"]"}function tf(t){return t==="component"||t==="Component"}const bT=(t,e)=>{if(zl(t)){const{children:n,loc:i}=t,{slotName:s,slotProps:r}=TT(t,e),o=[e.prefixIdentifiers?"_ctx.$slots":"$slots",s,"{}","undefined","true"];let a=2;r&&(o[2]=r,a=3),n.length&&(o[3]=Kr([],n,!1,!1,i),a=4),e.scopeId&&!e.slotted&&(a=5),o.splice(a),t.codegenNode=Pt(e.helper(j0),o,i)}};function TT(t,e){let n='"default"',i;const s=[];for(let r=0;r<t.props.length;r++){const o=t.props[r];o.type===6?o.value&&(o.name==="name"?n=JSON.stringify(o.value.content):(o.name=Mt(o.name),s.push(o))):o.name==="bind"&&Cs(o.arg,"name")?o.exp&&(n=o.exp):(o.name==="bind"&&o.arg&&hn(o.arg)&&(o.arg.content=Mt(o.arg.content)),s.push(o))}if(s.length>0){const{props:r,directives:o}=gv(t,e,s,!1,!1);i=r,o.length&&e.onError(gt(36,o[0].loc))}return{slotName:n,slotProps:i}}const wT=/^\s*([\w$_]+|(async\s*)?\([^)]*?\))\s*(:[^=]+)?=>|^\s*(async\s+)?function(?:\s+[\w$]+)?\s*\(/,_v=(t,e,n,i)=>{const{loc:s,modifiers:r,arg:o}=t;!t.exp&&!r.length&&n.onError(gt(35,s));let a;if(o.type===4)if(o.isStatic){let h=o.content;h.startsWith("vue:")&&(h=`vnode-${h.slice(4)}`);const f=e.tagType!==0||h.startsWith("vnode")||!/[A-Z]/.test(h)?Ur(Mt(h)):`on:${h}`;a=je(f,!0,o.loc)}else a=qn([`${n.helperString(Kh)}(`,o,")"]);else a=o,a.children.unshift(`${n.helperString(Kh)}(`),a.children.push(")");let l=t.exp;l&&!l.content.trim()&&(l=void 0);let c=n.cacheHandlers&&!l&&!n.inVOnce;if(l){const h=J0(l.content),f=!(h||wT.test(l.content)),d=l.content.includes(";");(f||c&&h)&&(l=qn([`${f?"$event":"(...args)"} => ${d?"{":"("}`,l,d?"}":")"]))}let u={props:[St(a,l||je("() => {}",!1,s))]};return i&&(u=i(u)),c&&(u.props[0].value=n.cache(u.props[0].value)),u.props.forEach(h=>h.key.isHandlerKey=!0),u},AT=(t,e,n)=>{const{modifiers:i,loc:s}=t,r=t.arg;let{exp:o}=t;if(!o&&r.type===4){const a=Mt(r.content);o=t.exp=je(a,!1,r.loc)}return r.type!==4?(r.children.unshift("("),r.children.push(') || ""')):r.isStatic||(r.content=`${r.content} || ""`),i.includes("camel")&&(r.type===4?r.isStatic?r.content=Mt(r.content):r.content=`${n.helperString(Yh)}(${r.content})`:(r.children.unshift(`${n.helperString(Yh)}(`),r.children.push(")"))),n.inSSR||(i.includes("prop")&&Xp(r,"."),i.includes("attr")&&Xp(r,"^")),!o||o.type===4&&!o.content.trim()?(n.onError(gt(34,s)),{props:[St(r,je("",!0,s))]}):{props:[St(r,o)]}},Xp=(t,e)=>{t.type===4?t.isStatic?t.content=e+t.content:t.content=`\`${e}\${${t.content}}\``:(t.children.unshift(`'${e}' + (`),t.children.push(")"))},CT=(t,e)=>{if(t.type===0||t.type===1||t.type===11||t.type===10)return()=>{const n=t.children;let i,s=!1;for(let r=0;r<n.length;r++){const o=n[r];if(zu(o)){s=!0;for(let a=r+1;a<n.length;a++){const l=n[a];if(zu(l))i||(i=n[r]=qn([o],o.loc)),i.children.push(" + ",l),n.splice(a,1),a--;else{i=void 0;break}}}}if(!(!s||n.length===1&&(t.type===0||t.type===1&&t.tagType===0&&!t.props.find(r=>r.type===7&&!e.directiveTransforms[r.name])&&t.tag!=="template")))for(let r=0;r<n.length;r++){const o=n[r];if(zu(o)||o.type===8){const a=[];(o.type!==2||o.content!==" ")&&a.push(o),!e.ssr&&Nn(o,e)===0&&a.push("1"),n[r]={type:12,content:o,loc:o.loc,codegenNode:Pt(e.helper(ud),a)}}}}},qp=new WeakSet,RT=(t,e)=>{if(t.type===1&&Vn(t,"once",!0))return qp.has(t)||e.inVOnce||e.inSSR?void 0:(qp.add(t),e.inVOnce=!0,e.helper(kl),()=>{e.inVOnce=!1;const n=e.currentNode;n.codegenNode&&(n.codegenNode=e.cache(n.codegenNode,!0))})},vv=(t,e,n)=>{const{exp:i,arg:s}=t;if(!i)return n.onError(gt(41,t.loc)),Wa();const r=i.loc.source,o=i.type===4?i.content:r,a=n.bindingMetadata[r];if(a==="props"||a==="props-aliased")return n.onError(gt(44,i.loc)),Wa();if(!o.trim()||!J0(o)&&!!1)return n.onError(gt(42,i.loc)),Wa();const c=s||je("modelValue",!0),u=s?hn(s)?`onUpdate:${Mt(s.content)}`:qn(['"onUpdate:" + ',s]):"onUpdate:modelValue";let h;const f=n.isTS?"($event: any)":"$event";h=qn([`${f} => ((`,i,") = $event)"]);const d=[St(c,t.exp),St(u,h)];if(t.modifiers.length&&e.tagType===1){const g=t.modifiers.map(m=>(bd(m)?m:JSON.stringify(m))+": true").join(", "),v=s?hn(s)?`${s.content}Modifiers`:qn([s,' + "Modifiers"']):"modelModifiers";d.push(St(v,je(`{ ${g} }`,!1,t.loc,2)))}return Wa(d)};function Wa(t=[]){return{props:t}}const PT=/[\w).+\-_$\]]/,LT=(t,e)=>{Hs("COMPILER_FILTERS",e)&&(t.type===5&&Xl(t.content,e),t.type===1&&t.props.forEach(n=>{n.type===7&&n.name!=="for"&&n.exp&&Xl(n.exp,e)}))};function Xl(t,e){if(t.type===4)jp(t,e);else for(let n=0;n<t.children.length;n++){const i=t.children[n];typeof i=="object"&&(i.type===4?jp(i,e):i.type===8?Xl(t,e):i.type===5&&Xl(i.content,e))}}function jp(t,e){const n=t.content;let i=!1,s=!1,r=!1,o=!1,a=0,l=0,c=0,u=0,h,f,d,g,v=[];for(d=0;d<n.length;d++)if(f=h,h=n.charCodeAt(d),i)h===39&&f!==92&&(i=!1);else if(s)h===34&&f!==92&&(s=!1);else if(r)h===96&&f!==92&&(r=!1);else if(o)h===47&&f!==92&&(o=!1);else if(h===124&&n.charCodeAt(d+1)!==124&&n.charCodeAt(d-1)!==124&&!a&&!l&&!c)g===void 0?(u=d+1,g=n.slice(0,d).trim()):m();else{switch(h){case 34:s=!0;break;case 39:i=!0;break;case 96:r=!0;break;case 40:c++;break;case 41:c--;break;case 91:l++;break;case 93:l--;break;case 123:a++;break;case 125:a--;break}if(h===47){let p=d-1,x;for(;p>=0&&(x=n.charAt(p),x===" ");p--);(!x||!PT.test(x))&&(o=!0)}}g===void 0?g=n.slice(0,d).trim():u!==0&&m();function m(){v.push(n.slice(u,d).trim()),u=d+1}if(v.length){for(d=0;d<v.length;d++)g=IT(g,v[d],e);t.content=g}}function IT(t,e,n){n.helper(pd);const i=e.indexOf("(");if(i<0)return n.filters.add(e),`${Qo(e,"filter")}(${t})`;{const s=e.slice(0,i),r=e.slice(i+1);return n.filters.add(s),`${Qo(s,"filter")}(${t}${r!==")"?","+r:r}`}}const $p=new WeakSet,DT=(t,e)=>{if(t.type===1){const n=Vn(t,"memo");return!n||$p.has(t)?void 0:($p.add(t),()=>{const i=t.codegenNode||e.currentNode.codegenNode;i&&i.type===13&&(t.tagType!==1&&Md(i,e),t.codegenNode=Pt(e.helper(Sd),[n.exp,Kr(void 0,i),"_cache",String(e.cached++)]))})}};function NT(t){return[[RT,uT,DT,dT,LT,bT,yT,gT,CT],{on:_v,bind:AT,model:vv}]}function UT(t,e={}){const n=e.onError||Ed,i=e.mode==="module";e.prefixIdentifiers===!0?n(gt(47)):i&&n(gt(48));const s=!1;e.cacheHandlers&&n(gt(49)),e.scopeId&&!i&&n(gt(50));const r=it({},e,{prefixIdentifiers:s}),o=ze(t)?zb(t,r):t,[a,l]=NT();return qb(o,it({},r,{nodeTransforms:[...a,...e.nodeTransforms||[]],directiveTransforms:it({},l,e.directiveTransforms||{})})),Yb(o,r)}const OT=()=>({props:[]});/**
* @vue/compiler-dom v3.4.15
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/const yv=Symbol(""),xv=Symbol(""),Sv=Symbol(""),Mv=Symbol(""),nf=Symbol(""),Ev=Symbol(""),bv=Symbol(""),Tv=Symbol(""),wv=Symbol(""),Av=Symbol("");_b({[yv]:"vModelRadio",[xv]:"vModelCheckbox",[Sv]:"vModelText",[Mv]:"vModelSelect",[nf]:"vModelDynamic",[Ev]:"withModifiers",[bv]:"withKeys",[Tv]:"vShow",[wv]:"Transition",[Av]:"TransitionGroup"});let or;function FT(t,e=!1){return or||(or=document.createElement("div")),e?(or.innerHTML=`<div foo="${t.replace(/"/g,"&quot;")}">`,or.children[0].getAttribute("foo")):(or.innerHTML=t,or.textContent)}const BT={parseMode:"html",isVoidTag:eS,isNativeTag:t=>Zx(t)||Jx(t)||Qx(t),isPreTag:t=>t==="pre",decodeEntities:FT,isBuiltInComponent:t=>{if(t==="Transition"||t==="transition")return wv;if(t==="TransitionGroup"||t==="transition-group")return Av},getNamespace(t,e,n){let i=e?e.ns:n;if(e&&i===2)if(e.tag==="annotation-xml"){if(t==="svg")return 1;e.props.some(s=>s.type===6&&s.name==="encoding"&&s.value!=null&&(s.value.content==="text/html"||s.value.content==="application/xhtml+xml"))&&(i=0)}else/^m(?:[ions]|text)$/.test(e.tag)&&t!=="mglyph"&&t!=="malignmark"&&(i=0);else e&&i===1&&(e.tag==="foreignObject"||e.tag==="desc"||e.tag==="title")&&(i=0);if(i===0){if(t==="svg")return 1;if(t==="math")return 2}return i}},kT=t=>{t.type===1&&t.props.forEach((e,n)=>{e.type===6&&e.name==="style"&&e.value&&(t.props[n]={type:7,name:"bind",arg:je("style",!0,e.loc),exp:HT(e.value.content,e.loc),modifiers:[],loc:e.loc})})},HT=(t,e)=>{const n=e_(t);return je(JSON.stringify(n),!1,e,3)};function ns(t,e){return gt(t,e)}const VT=(t,e,n)=>{const{exp:i,loc:s}=t;return i||n.onError(ns(53,s)),e.children.length&&(n.onError(ns(54,s)),e.children.length=0),{props:[St(je("innerHTML",!0,s),i||je("",!0))]}},zT=(t,e,n)=>{const{exp:i,loc:s}=t;return i||n.onError(ns(55,s)),e.children.length&&(n.onError(ns(56,s)),e.children.length=0),{props:[St(je("textContent",!0),i?Nn(i,n)>0?i:Pt(n.helperString(mu),[i],s):je("",!0))]}},GT=(t,e,n)=>{const i=vv(t,e,n);if(!i.props.length||e.tagType===1)return i;t.arg&&n.onError(ns(58,t.arg.loc));const{tag:s}=e,r=n.isCustomElement(s);if(s==="input"||s==="textarea"||s==="select"||r){let o=Sv,a=!1;if(s==="input"||r){const l=gu(e,"type");if(l){if(l.type===7)o=nf;else if(l.value)switch(l.value.content){case"radio":o=yv;break;case"checkbox":o=xv;break;case"file":a=!0,n.onError(ns(59,t.loc));break}}else Ab(e)&&(o=nf)}else s==="select"&&(o=Mv);a||(i.needRuntime=n.helper(o))}else n.onError(ns(57,t.loc));return i.props=i.props.filter(o=>!(o.key.type===4&&o.key.content==="modelValue")),i},WT=bn("passive,once,capture"),XT=bn("stop,prevent,self,ctrl,shift,alt,meta,exact,middle"),qT=bn("left,right"),Cv=bn("onkeyup,onkeydown,onkeypress",!0),jT=(t,e,n,i)=>{const s=[],r=[],o=[];for(let a=0;a<e.length;a++){const l=e[a];l==="native"&&Jo("COMPILER_V_ON_NATIVE",n)||WT(l)?o.push(l):qT(l)?hn(t)?Cv(t.content)?s.push(l):r.push(l):(s.push(l),r.push(l)):XT(l)?r.push(l):s.push(l)}return{keyModifiers:s,nonKeyModifiers:r,eventOptionModifiers:o}},Yp=(t,e)=>hn(t)&&t.content.toLowerCase()==="onclick"?je(e,!0):t.type!==4?qn(["(",t,`) === "onClick" ? "${e}" : (`,t,")"]):t,$T=(t,e,n)=>_v(t,e,n,i=>{const{modifiers:s}=t;if(!s.length)return i;let{key:r,value:o}=i.props[0];const{keyModifiers:a,nonKeyModifiers:l,eventOptionModifiers:c}=jT(r,s,n,t.loc);if(l.includes("right")&&(r=Yp(r,"onContextmenu")),l.includes("middle")&&(r=Yp(r,"onMouseup")),l.length&&(o=Pt(n.helper(Ev),[o,JSON.stringify(l)])),a.length&&(!hn(r)||Cv(r.content))&&(o=Pt(n.helper(bv),[o,JSON.stringify(a)])),c.length){const u=c.map(tr).join("");r=hn(r)?je(`${r.content}${u}`,!0):qn(["(",r,`) + "${u}"`])}return{props:[St(r,o)]}}),YT=(t,e,n)=>{const{exp:i,loc:s}=t;return i||n.onError(ns(61,s)),{props:[],needRuntime:n.helper(Tv)}},KT=(t,e)=>{t.type===1&&t.tagType===0&&(t.tag==="script"||t.tag==="style")&&e.removeNode()},ZT=[kT],JT={cloak:OT,html:VT,text:zT,model:GT,on:$T,show:YT};function QT(t,e={}){return UT(t,it({},BT,e,{nodeTransforms:[KT,...ZT,...e.nodeTransforms||[]],directiveTransforms:it({},JT,e.directiveTransforms||{}),transformHoist:null}))}/**
* vue v3.4.15
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:is,depthTest:!1,depthWrite:!1})}function mg(){return new Js({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Nd(),fragmentShader:`
		...
		`,blending:is,depthTest:!1,depthWrite:!1})}function gg(){return new Js({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Nd(),fragmentShader:`
		...
		`,blending:is,depthTest:!1,depthWrite:!1})}function Nd(){return`
...
`)}function EP(t){return[t.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(Pr).join(`
`)}function bP(t){const e=[];for(const n in t){const i=t[n];i!==!1&&e.push("#define "+n+" "+i)}return e.join(`
`)}function TP(t,e){const n={},i=t.getProgramParameter(e,t.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){const r=t.getActiveAttrib(e,s),o=r.name;let a=1;r.type===t.FLOAT_MAT2&&(a=2),r.type===t.FLOAT_MAT3&&(a=3),r.type===t.FLOAT_MAT4&&(a=4),n[o]={type:r.type,location:t.getAttribLocation(e,o),locationSize:a}}return n}function Pr(t){return t!==""}function Tg(t,e){const n=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return t.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,n).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function wg(t,e){return t.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const wP=/^[ \t]*#include +<([\w\d./]+)>/gm;function gf(t){return t.replace(wP,CP)}const AP=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function CP(t,e){let n=qe[e];if(n===void 0){const i=AP.get(e);if(i!==void 0)n=qe[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return gf(n)}const RP=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ag(t){return t.replace(RP,PP)}function PP(t,e,n,i){let s="";for(let r=parseInt(e);r<parseInt(n);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Cg(t){let e="precision "+t.precision+` float;
precision `+t.precision+" int;";return t.precision==="highp"?e+=`
#define HIGH_PRECISION`:t.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:t.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function LP(t){let e="SHADOWMAP_TYPE_BASIC";return t.shadowMapType===Vv?e="SHADOWMAP_TYPE_PCF":t.shadowMapType===rw?e="SHADOWMAP_TYPE_PCF_SOFT":t.shadowMapType===vi&&(e="SHADOWMAP_TYPE_VSM"),e}function IP(t){let e="ENVMAP_TYPE_CUBE";if(t.envMap)switch(t.envMapMode){case to:case no:e="ENVMAP_TYPE_CUBE";break;case Su:e="ENVMAP_TYPE_CUBE_UV";break}return e}function DP(t){let e="ENVMAP_MODE_REFLECTION";if(t.envMap)switch(t.envMapMode){case no:e="ENVMAP_MODE_REFRACTION";break}return e}function NP(t){let e="ENVMAP_BLENDING_NONE";if(t.envMap)switch(t.combine){case xu:e="ENVMAP_BLENDING_MULTIPLY";break;case Rw:e="ENVMAP_BLENDING_MIX";break;case Pw:e="ENVMAP_BLENDING_ADD";break}return e}function UP(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),7*16)),texelHeight:i,maxMip:n}}function OP(t,e,n,i){const s=t.getContext(),r=n.defines;let o=n.vertexShader,a=n.fragmentShader;const l=LP(n),c=IP(n),u=DP(n),h=NP(n),f=UP(n),d=n.isWebGL2?"":MP(n),g=EP(n),v=bP(r),m=s.createProgram();let p,x,_=n.glslVersion?"#version "+n.glslVersion+`
`:"";n.isRawShaderMaterial?(p=["#define SHADER_TYPE "+n.shaderType,"#define SHADER_NAME "+n.shaderName,v].filter(Pr).join(`
`),p.length>0&&(p+=`
`),x=[d,"#define SHADER_TYPE "+n.shaderType,"#define SHADER_NAME "+n.shaderName,v].filter(Pr).join(`
`),x.length>0&&(x+=`
...
`].filter(Pr).join(`
`)),o=gf(o),o=Tg(o,n),o=wg(o,n),a=gf(a),a=Tg(a,n),a=wg(a,n),o=Ag(o),a=Ag(a),n.isWebGL2&&n.isRawShaderMaterial!==!0&&(_=`#version 300 es
